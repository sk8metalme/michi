...
```bash
# Phase 0.0: 初期化
/kiro:spec-init calculator-app  # AI実行
...
### Phase 2: TDD実装の自動化（JIRA連携）

JIRA連携はAIコマンドが自動で行います：
...
michi jira:transition MICHI-123 "Ready for Review"

# コメント追加のみ
michi jira:comment MICHI-123 "PRを作成しました: https://github.com/..."
```
